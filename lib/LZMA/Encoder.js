...
define(['./Base','../RangeCoder','../LZ','../makeBuffer'], function(Base, RangeCoder, LZ, makeBuffer) {
'use strict';
...
Encoder.prototype.getPosLenPrice = function(pos, len, posState) {
  ...
  if (pos < Base.kNumFullDistances) {
    price = this._distancePrices[(lenToPosState * Base.kNumFullDistances) + pos];
  } else {
          ...
          if (lenTest6 < numAvailableBytesFull) {
            ...
            if (lenTest27 >= 2) {
              ...
              var curAndLenCharPrice7 = curAndLenPrice6 +
                ...
                getPrice(true, this._matchFinder.getIndexByte(lenTest6 - (curBack + 1) -1,
...
Encoder.prototype.codeOneBlock = function(inSize, outSize, finished){
  // XXXX CodeOneBlock is here! XXXXXXX
  // XXX IMPLEMENT ME XXXX
